...
# ========== ЕДА И НАПИТКИ (объединённая кнопка) ==========
...
# ========== ЕДА (добавление) – обработчики, вызываемые из объединённого меню ==========
...
# ========== НАПИТКИ (добавление) – обработчики, вызываемые из объединённого меню ==========
